        ...
        <div class="cf w-100 dt z-max vh-100 fixed top-0 left-0 right-0 bg-black-50">
            <div class="dtc v-mid vh-100 w-100 ph3 overflow-scroll">
                <div class="cf mw6 center br2 bg-light-gray pa3 relative overflow-x-scroll" style="max-height:90vh"> 
                    ...
                    <p class="f2-l f4 tracked fw6 bebas-font tc ttu tracked w-100"> New Benefit </p>

                    <div class="fl pa1 mv1 w-50">
                        <label class="db fw4 lh-copy f6 black">Name of Benefit</label>
                        <input class="pa2 bn br2 w-100 bg-black-20 " type="text" v-model="record.name" />
                    </div>
                    <div class="fl pa1 mv1 w-50">
                        <label class="db fw4 lh-copy f6 black">Type</label>
                        <select class="pa2 bn br2 w-100 bg-black-20" v-model="record.type">
                            <option></option>
                    ...
                    <div class="fl pa1 mv1 w-50">
                        <gradepicker ref="fetchId" label="Grade" @updateGrade="updateGrade" />
                    </div>
                    <div class="fl pa1 mv1 w-50">
                        <label class="db fw4 lh-copy f6 black">Amount</label>
                        <input class="pa2 bn br2 w-100 bg-black-20 " type="text" v-model="record.amount" />
                    </div>
...
<script type="text/javascript">
    ...
    export default {
        ...
        data() {return {
            url: "/api/jobs/createBenefit",
            record: { },
            myprofile: {ID:0, firstName:'', email:''},
            isSave:true,
        }},
        components: { gradepicker},
        created() {
